...
def findip(type, pagenum, targeturl, path):  # ip类型,条数,目标url,存放ip的路径
    list = {
        ...
        '1': 'https://ip.jiangxianli.com/?page=1&country=%E4%B8%AD%E5%9B%BD',  # xicidaili国内https代理
        '2': 'https://ip.jiangxianli.com/?page=2&country=%E4%B8%AD%E5%9B%BD',  # xicidaili国内高匿代理
    }
    url = random.choice(list)  # 配置url
    # print("url:",url)
